...
This year we would also like scholarship recipients to give a 20-30 minute online seminar about their work (details to be arranged with the IBS-AR Secretary).

## How to apply

[<button type="button" class="btn btn-primary">Application form</button>](docs/IBS-AR-Scholarships2026-application-form.docx) [<button type="button" class="btn btn-primary">Referee form</button>](docs/IBS-AR-Scholarships2026-referee-form.docx)

:::{.callout-important collapsable=false appearance='default' icon=true}
## 2026 closing date: Friday 20th March

The closing date for applications in 2026 is Friday 20th March.
...
- [Application form](docs/IBS-AR-Scholarships2026-application-form.docx)
- [Referee form](docs/IBS-AR-Scholarships2026-referee-form.docx)
